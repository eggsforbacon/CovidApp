...
public class Stream {
  ...
  */
  public static void printPrices(Scanner in, int[] totPrices, String[][] matNamesUnit, int[] howMany, int[][] prices, int where) {
    Operations.clsm();
    ...
    for (int i = 0; i < Operations.HARDWARE_SHOP.length; i++) {
      ...
      System.out.println("Domicilio: $" + totalDelivery[i]);
    }
